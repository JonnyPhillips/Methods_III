...
\includegraphics[width=\maxwidth]{figure/graph_ols_control1-2} 

\includegraphics[width=\maxwidth]{figure/graph_ols_control1-3} 

\includegraphics[width=\maxwidth]{figure/graph_ols_control1-4} 

\end{knitrout}
\columnbreak

The coefficient on $D$ is 2.211
\end{multicols}
\end{frame}
