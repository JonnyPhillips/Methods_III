...
\pause
\item Thursday 14h-16h - Class (105)
\pause
\item Thursday 16.15-17.30 - Class (105) OR Lab (122)
\pause
...
\begin{itemize}
\item A \textcolor{blue}{1 [unit of $D$]} change in the explanatory variable is associated with a \textcolor{blue}{$100*(e^{\beta_C}-1)\%$ change in the odds (relative probability, $\frac{p}{1-p}$)} of moving from the baseline category to the outcome category $C$, holding other variables constant
\end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
\item A \textcolor{blue}{1 [unit of $D$]} change in the explanatory variable is associated with a \textcolor{blue}{$100*(e^{\beta_C}-1)\%$ change in the odds (relative probability, $\frac{p}{1-p}$)} of moving up one unit on the outcome scale, holding other variables constant
\end{itemize}
\end{itemize}
\end{frame}
