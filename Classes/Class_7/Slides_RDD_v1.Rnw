...
\begin{frame}
\frametitle{Discontinuities}
<<chart2_binned, echo=FALSE,fig.keep='high',fig.height=3.2, fig.width=3.2, warning=FALSE, message=FALSE>>=
...
\end{itemize}
<<Density, echo=FALSE,fig.keep='high',fig.height=1.7, fig.width=1.7, warning=FALSE, message=FALSE, include=FALSE>>=
library(rddensity)
rddensity(data$run_var, c=threshold) %>% rdplotdensity(data$run_var)
@
\end{frame}
