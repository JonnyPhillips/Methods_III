...
However, we will not use her pre-prepared dataset - we will start the analysis by constructing our own.  
...
```{r}
rdplot(d_PMDB$Pct_Votes_2004, d_PMDB$Win_Margin_2000, p=4)
```
