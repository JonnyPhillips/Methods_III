...
Adding a caliper greatly affects the estimated treatment effect, which rises to 0.39% points (the exact value will vary as the algorithm includes a random process) and is statistically significant.
