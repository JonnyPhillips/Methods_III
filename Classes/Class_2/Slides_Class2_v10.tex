...
\begin{multline}
\item $$ATT=E(\alpha_i|D=1) = E (Y_1 - Y_0|D=1) = E(Y_1|D=1) - E(Y_0|D=1) = \\ \frac{\sum_i (Y_{1i} - Y_{0i}|D=1)}{N_{Treated}}$$
\end{multline}
\end{block}
\pause
\begin{block}{Average Treatment Effect on the Untreated (Control)}
\begin{multline}
\item $$ATU=E(\alpha_i|D=0) = E (Y_1 - Y_0|D=0) = E(Y_1|D=0) - E(Y_0|D=0) = \\ \frac{\sum_i (Y_{1i} - Y_{0i}|D=0)}{N_{Control}}$$
\end{multline}
\end{block}
\pause
\begin{itemize}
\item The three estimates are usually different
\begin{itemize}
\item The effect democracy has had in Europe is different to the effect if we introduced democracy in Africa
\end{itemize}
\end{itemize}
\end{frame}
...
\begin{table}[htbp]
  ...
  \caption{Potential Outcomes Example}
    ...
    \hline
     &  &      &      &  \bigstrut\\
    \hline
    \textbf{ATT} & 1 & 3     & 2.5     & 0.5 \bigstrut\\
\hline
    \end{tabular}%
  \label{tab:addlabel}%
\end{table}%
...
\begin{table}[htbp]
  ...
  \scalebox{0.7}{
    ...
    \hline
    \multicolumn{1}{|p{2.6cm}|}{\multirow{2}[4]{2cm}{\textbf{Controlled Experiments}}} & Field Experiments & \checkmark      & \checkmark  \bigstrut\\
\cline{2-4}          & Survey and Lab Experiments &  \checkmark     & \checkmark \bigstrut\\
    \hline
          &       &       &  \bigstrut\\
    \hline
    \multicolumn{1}{|p{2.6cm}|}{\multirow{3}[6]{2cm}{\textbf{Natural Experiments}}} & Randomized Natural Experiments &  \checkmark     &  \bigstrut\\
\cline{2-4}          & Instrumental Variables & \checkmark      &  \bigstrut\\
\cline{2-4}          & Discontinuities & \checkmark      &  \bigstrut\\
    \hline
          &       &       &  \bigstrut\\
    \hline
    \multicolumn{1}{|p{2.6cm}|}{\multirow{4}[8]{2cm}{\textbf{Observational Studies}}} & Difference-in-Differences &       &  \bigstrut\\
