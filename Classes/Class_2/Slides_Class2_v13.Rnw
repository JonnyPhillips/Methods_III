...
nodes <- tibble(id=1:3,
                label=c("Democracy","GDP Growth","Southern"),
                      color="aqua")
...
densities_y0 %>% ggplot() +
  ...
  annotate("text", x=8.3,y=0.03,label="Andean",colour="#d95f0e") +
  annotate("text", x=16,y=0.03,label="Southern",colour="black")
@
...
densities_y1 %>% ggplot() +
  ...
  annotate("text", x=14,y=0.03,label="Southern",colour="#238b45") +
  annotate("text", x=8.3,y=0.03,label="Andean",colour="black")
@
\end{frame}
...
\begin{frame}
\frametitle{Omitted Variable Bias}
<<Chart_1,echo=FALSE,warning=FALSE,message=FALSE,fig.keep='high',fig.height=3, fig.width=6>>=
Chart_data <- tibble(Country=c("Brazil","Argentina","Uruguay","Bolivia","Colombia","Peru"),
                     y0=c(3,5,3,2,4,2),
                       y1=c(6,8,3,0,4,4),
                       D=c(1,1,1,0,0,0)) %>%
...
Chart_data %>% ggplot() +
  ...
  geom_text(aes(x=y0, y=y1, colour=D, label=Country), vjust=-2) +
...
\begin{frame}
\frametitle{Omitted Variable Bias}
<<Chart_1b,echo=FALSE,warning=FALSE,message=FALSE,fig.keep='high',fig.height=3, fig.width=6>>=
Chart_data <- tibble(Country=c("Brazil","Argentina","Uruguay","Bolivia","Colombia","Peru"),
                     y0=c(3,5,3,2,4,2),
                       y1=c(6,8,3,0,4,4),
                       D=c(1,1,1,0,0,0)) %>%
...
Chart_data %>% ggplot() +
  ...
  scale_y_continuous(expand = c(0, 0), limits=c(-1,10)) +
  scale_x_continuous(expand = c(0, 0), limits=c(-1,10)) +
  geom_segment(x=8/3,xend=8/3,y=-1,yend=10,lty=2, colour="orange") +
  geom_segment(y=17/3,yend=17/3,x=-1,xend=10,lty=2, colour="dark green")
@
\begin{itemize}
...
\begin{frame}
\frametitle{Reverse Causation}
<<Chart_2,echo=FALSE,warning=FALSE,message=FALSE,fig.keep='high',fig.height=3, fig.width=6>>=
Chart_data <- tibble(Country=c("Brazil","Argentina","Uruguay","Bolivia","Colombia","Peru"),
                     y0=c(3,5,3,2,4,2),
                       y1=c(6,8,3,0,4,4),
                       D=c(1,1,0,0,1,0)) %>%
...
Chart_data %>% ggplot() +
  ...
  scale_y_continuous(expand = c(0, 0), limits=c(-1,10)) +
  scale_x_continuous(expand = c(0, 0), limits=c(-1,10)) +
  geom_segment(x=7/3,xend=7/3,y=-1,yend=10,lty=2, colour="orange") +
  geom_segment(y=6,yend=6,x=-1,xend=10,lty=2, colour="dark green")
@
\begin{itemize}
...
\begin{frame}
\frametitle{Self-Selection Bias}
<<Chart_3,echo=FALSE,warning=FALSE,message=FALSE,fig.keep='high',fig.height=3, fig.width=6>>=
Chart_data <- tibble(Country=c("Brazil","Argentina","Uruguay","Bolivia","Colombia","Peru"),
                     y0=c(3,5,3,2,4,2),
                       y1=c(6,8,3,0,4,4),
                       D=c(1,1,0,0,0,1)) %>%
...
Chart_data %>% ggplot() +
  ...
  scale_y_continuous(expand = c(0, 0), limits=c(-1,10)) +
  scale_x_continuous(expand = c(0, 0), limits=c(-1,10)) +
  geom_segment(x=3,xend=3,y=-1,yend=10,lty=2, colour="orange") +
  geom_segment(y=6,yend=6,x=-1,xend=10,lty=2, colour="dark green")
@
\begin{itemize}
