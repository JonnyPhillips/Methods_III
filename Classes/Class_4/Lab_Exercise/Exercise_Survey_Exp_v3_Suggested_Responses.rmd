...
1. Respondents were primed with one of two questions ('hope' and 'anger', variable `Primed`). How does this prime affect subsequent answers to the question about the need for constitutional reform (variable `Constitution_Reform_Support`)? Calculate the difference-in-means estimate of the average treatment effect. Interpret the result.
