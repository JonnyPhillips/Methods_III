...
\pause
\item \textbf{Theory:} Higher incomes raise the demand for democracy, and diversify power away from the state
\pause
...
\pause
\columnbreak
\item \textbf{Alternative Theory:} Or was it American pressure?
\pause
